 ...
 *  
 *  Initialise a semaphore and set its condition variable
 *  and mutex to default values.
 *
 ...
 *  
 *   Destroy the mutex if and only if
 *   there are no threads waiting on 
 *   the semaphore
 *
 ...
 *  
 *  If the semaphore count value is equal to
 *  or less than zero then wait for 
 *  the count to become positive.
 *
...
/** @brief Function to wake thread waiting on the semaphore
 *         and signal
 *  
 *
