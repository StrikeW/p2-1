...
/** @brief  Function to initialize rwlock 
 *    
 *  Rwlock datastructure initialised to default values. 
 *    
 *  @param  rwlock: read write lock  data structure 
 *  @return RWLOCK_INIT_SUCC on success 
 *          RWLOCK_INIT_FAIL on failure
 */
int
...
/** @brief  Function to lock rwlock
 *    
 *  @param  rwlock: A read write lock data structure
 *  @param  type: type of lock read/write
 *  @return void
 */
void
...
/** @brief  Function to downgrade read write lock   
 *    
 *  @param  rwlock: A read write lock data structure
 *  @return void
 */
