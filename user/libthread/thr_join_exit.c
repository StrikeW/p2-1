 ...
 *  @brief  contains implmentation of thread join and thread exit 
 *
 ...
 *  
 *  Find the thread to be joined and wait for it to exit and 
 *  return exit status.
 *
...
void thr_exit( void *status )
{
    ...
    /* If we cannot find that tid, means that main thread has called 
     * thr_exit */
    if(exit_thr == NULL){
