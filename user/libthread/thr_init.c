 ...
 *  
 *  This function intialises the stack size for every 
 *  thread as provided by the user.
 *   
 *  It also allocates tcb for the main thread and
 *  initialises the thread list. 
 * 
