 ...
 *  @brief 
 *
 *   Implement thread safe malloc variants
 *   and free function.
 *
 *
...
/** @brief Function to check whether malloc
 *         lock needs to be initialised.
...
/** @brief Function to check whether calloc
 *         lock needs to be initialised.
 *         If it is not initialised, 
 *         lock and initialise.
 *  
...
/** @brief Function to check whether realloc
 *         lock needs to be initialised.
 *         If it is not initialised, 
 *         lock and initialise.
 *  
...
/** @brief Function to check whether free
 *         lock needs to be initialised.
 *         If it is not initialised, 
 *         lock and initialise.
 *  
